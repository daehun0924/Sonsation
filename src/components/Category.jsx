...
// import { categories, videoData } from './CategoryData';
...
//             <VideoGrid videos={videoData[activeTab]} currentPage={currentPage} setCurrentPage={setCurrentPage} />
//         </Container>
//     );
// };
...
//                 <Card.Text className="text-muted small text-truncate">{description}</Card.Text>
//             </Card.Body>
//             <Card.Footer className="category-card-footer">
//                 <Button variant="link" size="sm" className="watch-button" onClick={() => navigate('/video')}>
//                     학습하러 가기
//                 </Button>
